/**
	...
	from a Linear Congruential Generator. The set is
...
public class RandomSet {
	...
	/**
		Constructor
		This method initializes a Random Set to be filled
		with pseudorandom numbers from the generator. The
		set is filled with all pseudorandom numbers in the
		recurrence relation period for given parameters.
	...
	*/
	public RandomSet(int seed, int multiplier, int increment, int mod) {
		...
		this.gen = new Generator(seed, multiplier, increment, mod);
	...
	/**
		Get period length
		Returns the period length of this set.
	...
	*/
	...
	/**
		Get cycle length
		Returns the cycle length of this set.
		@return		Cycle length.
	*/
	...
	/**
		Get tail length
		Returns the tail length of this set.
		@oaram		Tail length.
	*/
	...
	/**
		Save
		Pushes the current pseudorandom number into
		the set.
		@return		Nothing.
	*/
	private void save() {
	...
	/**
		Generate period
		Generates all pseudorandom numbers in the set period
		and saves them.
		@return		Nothing.
	*/
	...
	/**
		Get period
		Returns the whole set as array.
	...
	*/
	...
	/**
		Get cycle
		Returns the set cycle as array.
	...
	*/
	...
	/**
		To string
		Builds a string representation of the set.
	...
	*/
	...
	/**
		Generate
		Generates first n elements of the recurrence
		relation.
	...
	*/
	public static void main(String[] args) {
		RandomSet set = new RandomSet(111, 8421, 9943, 11791);
		System.out.println(set.toString());
		
		int[] a = new Generator(111, 8421, 9943, 11791).generate(16384);
		int[] b = set.generate(16384);
		
		for(int i = 0; i < a.length; i++) {
			if(a[i] != b[i]) {
				System.out.println("Failed at " + i + ": [" + a[i] + ", " + b[i] + "]");
			}
		}
